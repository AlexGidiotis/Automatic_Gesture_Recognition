...
flag_path = 'Dimitris'
if flag_path == 'Alex':
    path = 'C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts'
    path_test = 'C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts'
elif flag_path == 'Dimitris':
    path = '/home/dimitris/GitProjects/Automatic_Gesture_Recognition/Training_HOG_Scripts'
...
if flag == 'Training':
    ...
    if flag_path == 'Alex':
        mlf = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\phones0.mlf", "w")
        train_scp = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\Train.scp")
    elif flag_path == 'Dimitris':
        mlf = open(path + "/phones0.mlf",'w')
        train_scp = open(path + '/Train.scp')
...
#=================================================== Isolated Training =========================================================
    ...
    if embed_flag == 'Isolated':
        for line in train_scp:
            ...
            if flag_path == 'Alex':
                lf = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\train_labels\\"+name+'.lab','w')
            elif flag_path == 'Dimitris':
...
#=================================================== Embedded Training ==========================================================
        ...
        if flag_path == 'Alex':
            lab_file = open('C:\Users\Alex\Documents\University\Python\Data\MFC_HOG_data\\label_file.txt')
        elif flag_path == 'Dimitris':
            lab_file = open('/home/dimitris/GitProjects/Automatic_Gesture_Recognition/Data/MFC_HOG_data/label_file.txt')
...
#============================================================== Testing ========================================================================
    ...
    # Create the output .mlf file
    mlf = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\testphones0.mlf", "w")
    # Phonemes label file starts with #!MLF!#
    mlf.write("#!MLF!#\n")

    train_scp = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\Test.scp")
...
#=================================================== Isolated Testing ==========================================================   
    if embed_flag == 'Isolated':
        ...
        for line in train_scp:
            ...
            # Also create a .lab file and write the class in there too.
            lf = open("C:\Users\Alex\Documents\University\Python\Automatic_Gesture_Recognition\Training_HOG_Scripts\\test_labels\\"+name+'.lab','w')
            lf.write(label)
            lf.close()
...
#=================================================== Embedded Testing ==========================================================
        ...
        # Read the class sequences from the lab file.
        if flag_path == 'Alex':
            lab_file = open('C:\Users\Alex\Documents\University\Python\Data\MFC_HOG_test_data\\label_file.txt')
        elif flag_path == 'Dimitris':
            lab_file = open('/home/dimitris/GitProjects/Automatic_Gesture_Recognition/MFC_HOG_test_data/label_file.txt')
        ...
        for line, lab_line in zip(train_scp,lab_file):
            ...
            if flag_path == 'Alex':
                ...
                lf = open(path +"/test_labels/"+name+'.lab','w')
