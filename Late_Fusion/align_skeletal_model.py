...
in_f = open('/home/alex/Documents/git_projects/Automatic_Gesture_Recognition/Training_Scripts/recout.mlf', 'r')
...
for file in af['file'].unique():
	...
	for k,g in sil_labs.groupby(sil_labs['frame'] - np.arange(sil_labs.shape[0])):
		...
		file_sil_list.append((int(start * 100000),int(end * 100000),'SIL'))
